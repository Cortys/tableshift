...
def get_icd9(depths=(3, 4)) -> dict:
    ...
    for depth in depths:
        depth_mapping = {
            _preprocess_code_text(c["code"]): c["descr"]
            for group in icd9_codes
            for c in group
            if c["depth"] == depth
        }
...
# is not clear.
DIABETES_READMISSION_FEATURES = FeatureList(
    features=[
        Feature(
            "race",
            cat_dtype,
    ...
    unknown/invalid.""",
        ...
        Feature(
            "age",
            cat_dtype,
            """Nominal. Grouped in 10-year intervals: [0, 
    10), [10, 20), . . ., [90, 100)""",
        ),
        Feature(
            "weight", cat_dtype, "Weight in pounds. Grouped in 25-pound intervals."
        ),
        Feature(
            "admission_type_id",
            int,
            """Integer identifier corresponding 
    ...
    to 21 distinct values.""",
        ...
        Feature(
            "payer_code",
            cat_dtype,
            "Integer identifier corresponding to 23 "
        ...
        Feature(
            "number_outpatient",
            float,
            "Number of outpatient visits of the "
        ...
        Feature(
            "diag_1",
            cat_dtype,
            "The primary diagnosis (coded as first three "
        ...
        Feature(
            "diag_2",
            cat_dtype,
            "Secondary diagnosis (coded as first three "
        ...
        Feature(
            "diag_3",
            cat_dtype,
            "Additional secondary diagnosis (coded as "
        ...
        Feature(
            "max_glu_serum",
            cat_dtype,
            "Indicates the range of the result or "
        ...
        Feature(
            "A1Cresult",
            cat_dtype,
            "Indicates the range of the result or if "
        ...
        Feature(
            "metformin",
            cat_dtype,
            "Indicates if there was a change in "
        ...
        Feature(
            "change",
            cat_dtype,
            "Indicates if there was a change in diabetic "
        ...
        Feature(
            "diabetesMed",
            cat_dtype,
            "Indicates if there was any diabetic "
