...
ANES_FEATURES = FeatureList(
    features=[
        Feature(
            "VCF0702",
            int,
            "DID RESPONDENT VOTE IN THE NATIONAL "
    ...
    used""",
        ...
        Feature("VCF0218", float, name_extended="Democratic Party feeling thermometer"),
        Feature("VCF0224", float, name_extended="Republican Party feeling thermometer"),
        Feature(
            "VCF0301",
            cat_dtype,
        ...
        Feature(
            "VCF0428",
            float,
            name_extended="President thermometer",
            na_values=(98.0, 99.0),
        ),
        Feature(
            "VCF0429",
            float,
            name_extended="Vice-president thermometer",
            na_values=(98.0, 99.0),
        ),
        ...
        Feature(
            ...
            value_mapping={"1.0": "No ", "2.0": "Yes", "0.0": "no answer"},
        ),
        Feature(
            "VCF0718",
            cat_dtype,
        ...
        Feature("VCF0101", int, "RESPONDENT - AGE", name_extended="age"),
        Feature(
            "VCF0104",
            cat_dtype,
            name_extended="gender",
            value_mapping={"1": "Male", "2": "Female", "3": "Other", "0": "no answer"},
        ),
        Feature(
            "VCF0105a",
            cat_dtype,
        ...
        Feature(
            "VCF0112",
            cat_dtype,
            """Region - U.S. Census 1. Northeast (CT, 
